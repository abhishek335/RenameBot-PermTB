...
<b>Send me any Telegram file and reply to that file with /rename NewName.extn</b>"""
    ...
    UPGRADE_TEXT = "CONTACT @H4CK3R_OO7"
    DOWNLOAD_START = "Downloading...Give Me Some Time Bruh Join *@Empire_Cinemas!!"
    UPLOAD_START = "Hurray... Completed Downloading"
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry WTF Do You Think! I'll Upload It?"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me JOin > @Empire_Cinemas**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT @H4CK3R_OO7"
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @H4CK3R_OO7"
    ...
    HELP_USER = """Sorry.. This Bot Can Only Be Used in Cinema Factory Group Admins 😎"""
